...
//CIBlock::disableTagCache(IBLOCK_GROUPS);
//CIBlock::disableTagCache(IBLOCK_TAGS);
//
//CJSCore::Init(['fx']);
...
//
//// LOCATION NEW
//require_once($_SERVER['DOCUMENT_ROOT'].'/local/php_interface/include/qsoft/classes/Location.php');
...
//// dadata
//require_once($_SERVER['DOCUMENT_ROOT'] . '/local/php_interface/include/dadata.php');
//// UTM tags
