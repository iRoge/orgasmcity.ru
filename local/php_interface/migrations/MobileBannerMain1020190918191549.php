...
class MobileBannerMain1020190918191549 extends Version
{
    ...
    public function up()
    {
        ...
        try {
            $iblockId = $helper->Iblock()->saveIblock(array(
                ...
                'CODE' => 'main_slider_mobile_10',
                'NAME' => 'Слайдер на главной мобильный 10',
                'ACTIVE' => 'Y',
                'SORT' => '500',
    ...
    public function down()
    {
        ...
        $helper->Iblock()->deleteIblockIfExists("main_slider_mobile_10", "CONTENT");
    }
}
