...
class MobileBannerMain920190918191546 extends Version
{
    ...
    public function up()
    {
        ...
        try {
            $iblockId = $helper->Iblock()->saveIblock(array(
                ...
                'CODE' => 'main_slider_mobile_9',
                'NAME' => 'Слайдер на главной мобильный 9',
                'ACTIVE' => 'Y',
                'SORT' => '500',
    ...
    public function down()
    {
        ...
        $helper->Iblock()->deleteIblockIfExists("main_slider_mobile_9", "CONTENT");
    }
}
