...
class addIblockAdvantageInCatalogElement20201117154918 extends Version
{
    protected $description = "Создает ИБ Преимущества в карточке товара";
    ...
    public function up()
    {
        $this->createIB('advantagesInCatalogElement', 'Преимущества в карточке товара');
    }

    public function down()
    {
        $this->deleteIB('advantagesInCatalogElement');
    }
