...
class Version20171108104319 extends Version {

    protected $description = "Создание свойства слайдер для баннеров";
    ...
    public function up(){
        ...
        $iblockId = $helper->Iblock()->addIblockIfNotExists(array (
            ...
            'ACTIVE' => 'Y',
            'SORT' => '500',
            'LIST_PAGE_URL' => '/actions/',
            'DETAIL_PAGE_URL' => '/actions/#ELEMENT_CODE#/',
            'SECTION_PAGE_URL' => '/actions/',
            'CANONICAL_PAGE_URL' => '',
            'PICTURE' => NULL,
            'DESCRIPTION' => '',
        ...
        $helper->Iblock()->addPropertyIfNotExists($iblockId, array (
            'NAME' => 'Показывать при успешном оформлении заказа',
            'ACTIVE' => 'Y',
            'SORT' => '600',
            'CODE' => 'SHOW_IN_ORDER_SUCCESS',
            'DEFAULT_VALUE' => '',
            'PROPERTY_TYPE' => 'L',
            'ROW_COUNT' => '1',
            'COL_COUNT' => '30',
