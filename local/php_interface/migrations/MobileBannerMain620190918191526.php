...
class MobileBannerMain620190918191526 extends Version
{

    protected $description = "Мобильный слайдер 3";
    ...
    public function up()
    {
        ...
        try {
            $iblockId = $helper->Iblock()->saveIblock(array(
                ...
                'CODE' => 'main_slider_mobile_3',
                'NAME' => 'Слайдер на главной мобильный 3',
                'ACTIVE' => 'Y',
                'SORT' => '500',
    ...
    public function down()
    {
        ...
        $helper->Iblock()->deleteIblockIfExists("main_slider_mobile_3", "CONTENT");
    }
}
