...
class MobileBannerMain520190918191520 extends Version
{

    protected $description = "Мобильный слайдер 2";
    ...
    public function up()
    {
        ...
        try {
            $iblockId = $helper->Iblock()->saveIblock(array(
                ...
                'CODE' => 'main_slider_mobile_2',
                'NAME' => 'Слайдер на главной мобильный 2',
                'ACTIVE' => 'Y',
                'SORT' => '500',
                    ...
                    array(
                        0 =>
                            array(
                                ...
                                'DEF' => 'N',
                                'SORT' => '500',
                                'XML_ID' => '97aa800c850edbf7679c520b771c37be',
                            ),
                    ),
            ));
            $helper->Iblock()->saveProperty($iblockId, array(
    ...
    public function down()
    {
        ...
        $helper->Iblock()->deleteIblockIfExists("main_slider_mobile_2", "CONTENT");
    }
}
