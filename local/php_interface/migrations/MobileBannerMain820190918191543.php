...
class MobileBannerMain820190918191543 extends Version
{
    ...
    public function up()
    {
        ...
        try {
            $iblockId = $helper->Iblock()->saveIblock(array(
                ...
                'CODE' => 'main_slider_mobile_8',
                'NAME' => 'Слайдер на главной мобильный 8',
                'ACTIVE' => 'Y',
                'SORT' => '500',
    ...
    public function down()
    {
        ...
        $helper->Iblock()->deleteIblockIfExists("main_slider_mobile_8", "CONTENT");
    }
}
