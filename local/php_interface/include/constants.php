...
define('ONLINE_PAYMENT_CODES', ['TINKOFF']); //Массив кодов платежных систем для оплаты онлайн
...
// Телефон поддержки
define('SUPPORT_PHONE', '+7 (495) 197-78-69'); // Путь к файлу с политикой конфиденциальности
...
// Тинькофф эквайринг
define('TINKOFF_TERMINAL_ID', '1625037822712DEMO');
define('TINKOFF_TERMINAL_PASSWORD', 'x6n41syo9oy8nzck');