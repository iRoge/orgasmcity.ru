...
class Rests2 extends Rests
{
    ...
    private function read()
    {
        ...
        $this->reader->on('rest', function ($reader, $xml) {
            ...
            $iExist = $this->offers[$iProduct][$rest['offer_id']]['ID'] ?: false;
            ...
            $this->rests[$rest["offer_id"] . "-" . $rest["store_id"]] = [
                ...
                'OFFER_ID' => $iExist,
                'OFFER_XML_ID' => $this->offers[$iProduct][$rest['offer_id']]['XML_ID'],
    ...
    private function load()
    {
        ...
        $arOffersIds = [];
        while ($arElement = $rsElements->Fetch()) {
            $this->offers[$arElement['PROPERTY_CML2_LINK_VALUE']][$arElement['XML_ID']] = $arElement;
