    ...
    <div class="slider">
        <div id="main-slider" class="slides<? !empty($arResult['ITEMS'][0]['VIDEO']) and print ' slides--with-video' ?>"<? !empty($arResult['SLICK']) and print " data-slick='".json_encode($arResult['SLICK'])."'"; ?>>
            ...
            <div class="main-top col-xs-12">
                <div class="main">
                    <div class="col-sm-6">
                        <div class="in-main-top col-xs-12">
                            <img src="<?= SITE_TEMPLATE_PATH; ?>/img/respect1.png" />
                            <span>Коллекции&nbsp;&nbsp;&nbsp; —</span>
                            <h2><?= $arItem['NAME'] ?></h2>
                            <p>
                                <?= $arItem['PREVIEW_TEXT'] ?>
                            </p>
                            <a href="#"><?= $arItem['PROPERTIES']['LINK_TEXT']['VALUE'] ?></a>
                        </div>
                    </div>
                    <div class="col-sm-5 col-sm-offset-1 shoes-top">
                        <img src="<?= SITE_TEMPLATE_PATH; ?>/img/shoes-main-top.png"/>
                    </div>
                    <div class="col-sm-12">
                        <div class="in-main-top col-xs-12">
                ...
                $bannerImg = '<img width="100%" src="'.$arItem['PREVIEW_PICTURE']['SRC'].'" alt="" data-mob-img="'.$arItem['MOBILE_SRC'].'" />';
            ?>
                    <?
