                                                            ...
                                                            <a href="<?= $arItem2Level['LINK'] ?>">
																<?php if (!$arItem2Level['IS_PARENT']) { ?>
                                                                    <span class="hide-menu-icons"
                                                                          style="background-image:url(<?= $arItem2Level["PARAMS"]["IMG_PATH"] ?>)"></span>
																<?php } ?>
																<?= $arItem2Level['TEXT'] ?>
                                                            </a>
                                                        </p>
                                                        ...
                                                        <div class="col-md-<?= $class[1] ?> lvl3-items-block">
															<?php foreach ($arItem3LevelChunks as $arItem3Level) { ?>
                                                                <a href="<?= $arItem3Level['LINK']; ?>"
                                                                   class="<?= ($arItem3Level["PARAMS"]["CLASS"] ? ' ' . $arItem3Level["PARAMS"]["CLASS"] : '') ?>">
                                                                    <span class="hide-menu-icons"
                                                                          style="background-image:url(<?= $arItem3Level["PARAMS"]["IMG_PATH"] ?>)"></span>
