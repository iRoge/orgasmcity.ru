...
<!--<section style="background-image: url('<?/*= SITE_TEMPLATE_PATH; */?>/images/products-list/hero.jpg')"
         class="hero phone--hidden">
    <div class="container">
        <div class="column-10">
            <div class="hero__content">
                <h1>Поиск</h1>
                <a href="#products-list" class="hero-scroll-down"><i class="icon icon-arrow-bottom"></i></a>
            </div>
        </div>
    </div>
</section>-->
...
<? if (empty($sSearch)): ?>
    <div class="container column-center text--center" style="padding: 45px 0 45px; font-size: 1.35rem;">
