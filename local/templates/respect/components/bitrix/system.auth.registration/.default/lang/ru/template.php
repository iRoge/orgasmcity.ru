...
$MESS ['AUTH_EMAIL_SENT'] = "На указанный в форме адрес электронной почты было выслано письмо с информацией о подтверждении регистрации.";
$MESS ['AUTH_EMAIL'] = "Эл. почта";
