                            ...
                            <div class="catalog__settings-line">
                                ...
                                <span class="view__item catalog-sort catalog-sort--mobile-icon">
                                    ...
                                    <span class="view__item view__item--big js-view-item <?= $arResult['USER_SETTINGS']['GRID'] == 'big' ? 'view__item--active' : '' ?>"
                                        ...
                                        <svg width="25" height="25" fill="#b8b4b4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
                                            <path d="M22 23H5c-.552 0-1-.448-1-1V5c0-.552.448-1 1-1h17c.552 0 1 .448 1 1v17C23 22.552 22.552 23 22 23zM45 23H28c-.552 0-1-.448-1-1V5c0-.552.448-1 1-1h17c.552 0 1 .448 1 1v17C46 22.552 45.552 23 45 23zM22 46H5c-.552 0-1-.448-1-1V28c0-.552.448-1 1-1h17c.552 0 1 .448 1 1v17C23 45.552 22.552 46 22 46zM45 46H28c-.552 0-1-.448-1-1V28c0-.552.448-1 1-1h17c.552 0 1 .448 1 1v17C46 45.552 45.552 46 45 46z">
                                            </path>
                                        </svg>
                                    </span>
                                </div>
                    ...
                    <div class="catalog__content-col catalog__content-col--sidebar js-filter-col filter col-xs-3">
                        <div class="filter__displayed">
                            <div class="filter-reset-container">
                                <button class="js-filter-button-reset filter-reset-btn filter__disabled-reset-btn"
                        ...
                        <div class="filters js-filter-wrapper filter__wrapper">
                            <input hidden disabled type="text" class="all-items-count"
                                   value="<?= $arResult['MODELS_COUNT'] ?>">
                            ...
                            <form class="form filter__form js-filter-form" name="_form"
								...
								<?php if (!empty($arResult['SAME_SECTIONS']) && $arResult['IS_AJAX']) : ?>
                                    <div class="in-left-catalog subsections-block">
                                        ...
                                        <div class="in-in-left scrollbar-inner max-height-400"
                                             data-filter="type" <?= $GLOBALS['device_type'] == 'mobile' ? 'style="display: none"' : 'style="display: flex;"' ?>>
                                            <ul class="filter__main-list">
												<?php foreach ($arResult['SAME_SECTIONS'] as $section) : ?>
                                                    <li class="filter__type-item">
                                                        <a class="name-h3" href="<?= $section['SECTION_PAGE_URL'] ?>"
                                                           style="display: block; width: 100%; font-weight: bold; font-family: 'gilroyRegular'; font-size: 15px; color: #000000;">
															<?= $section['NAME'] ?>
                                                        </a>
                                                    </li>
												<?php endforeach; ?>
                                        ...
                                        <div class="in-left-catalog in-left-catalog--price<?= $arResult['FILTER']['CHECKED'][$filterKey] ? ' in-left-catalog--checked' : '' ?>">
                                            ...
                                            <div class="in-in-left"<?= $arResult['FILTER']['CHECKED'][$filterKey] ? ' style="display:flex"' : '' ?>>
                                                <div class="from-filter">
                                                    <span>От:</span>
                                                    <input id="min_<?= strtolower($filterKey) ?>"
                                                           class="js-number-filter" type="number"
                                                ...
                                                <div class="to-filter">
                                                    <span>До:</span>
                                                    <input id="max_<?= strtolower($filterKey) ?>"
                                                           class="js-number-filter" type="number"
												...
												<?php foreach ($value as $xml_id => $color) : ?>
                                                    <div class="outer-color">
                                                        <input id="color_<?= $xml_id ?>"
															...
															<?php endif; ?>
                                                        />
                                                        <label for="color_<?= $xml_id ?>"
                                                               class="label-for-color <?= $color['DISABLED'] ? 'mydisabled' : '' ?>">
															<?php if ($color['VALUE']['IMG_SRC']) : ?>
                                                                <img class="inner-color" width="22" height="22"
                                                                     src="<?= $color['VALUE']['IMG_SRC']; ?>" alt="">
															<?php endif; ?>
															<?= $color['VALUE']['UF_NAME']; ?>
                                                        </label>
                                                    </div>
                                                ...
                                                <div class="product-icons-wrap">
													...
													<?php if ($arItem['PROPERTY_NEW_VALUE']) { ?>
                                                        <svg height="100%" width="100%"
                                                            ...
                                                            <path d="M34.5728 14.0577C34.7538 14.0577 34.9005 13.911 34.9005 13.73C34.9005 13.5491 34.7538 13.4023 34.5728 13.4023C34.3918 13.4023 34.2451 13.5491 34.2451 13.73C34.2451 13.911 34.3918 14.0577 34.5728 14.0577Z"
                                                                  stroke="white" stroke-linecap="round"
                                                                  stroke-linejoin="round"/>
                                                            <defs>
                                                                <linearGradient id="paint1_linear" x1="0" y1="15.5"
                                                                                x2="62" y2="15.5"
                                                                                gradientUnits="userSpaceOnUse">
													...
													<?php if ($arItem['DISCOUNT']) { ?>
                                                        ...
                                                        <div class="sale-tooltip"
                                                             title="Размер скидки"><?= -$arItem['DISCOUNT'] ?>%
                                                        </div>
													<?php } ?>
                                                </div>
                                                <button title="Добавить в избранное" type="button"
                                                        class="heart__btn<?= isset($arResult['FAVORITES_PROD_IDS'][$arItem['ID']]) ? ' active' : '' ?> js-favour-heart"
                                                        data-id="<?= $arItem['ID'] ?>">
                                                    <svg width="30" height="30" viewBox="0 0 23 22"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M0 5.86414C0 -0.440483 8.73003 -2.77704 11.4163 4.52139C14.1025 -2.77704 22.8325 -0.440483 22.8325 5.86414C22.8325 12.714 11.4163 21.3989 11.4163 21.3989C11.4163 21.3989 0 12.714 0 5.86414Z"
                                                              fill="black"/>
                                                    </svg>
                                                </button>
                                                <a target="_blank" class="product-href-wrapper"
                                                   href="<?= $arItem["DETAIL_PAGE_URL"] ?>">
                                                    <div class="product-img-wrapper">
                                                        <img class="product-img lazy-img"
                                                             data-src="<?= $arItem["DETAIL_PICTURE"] ?>"
                                                             alt="<?= $arItem['NAME'] ?>">
                                                    </div>
