...
<? if (!empty($arResult['ITEMS'])): ?>
    <div class="container product-page">
        <div class="column-8 pre-1">
            <h3 class="mt-phone-3">Вам может понравиться</h3>
            <div class="products-grid  products-grid--gitter b-recommended-product">
                                    ...
                                    <div class="products-item__information">
                                        ...
                                        <div class="container">
                                            <div class="column-5">
                                                ...
                                                ?>
                                                <div class="products-item__cost<?= $bDiscount ? ' discount' : ''; ?>">
                                                    <? if ($bDiscount): ?>
                                                        <span class="product__cost-segment--<?= $arItem['MIN_PRICE']['DISCOUNT_SEGMENT'] ?>"><?= $arItem['MIN_PRICE']['PRINT_DISCOUNT_VALUE']; ?></span>
                                                        <div class="product__old-cost">
                                                            <?= $arItem['MIN_PRICE']['PRINT_VALUE']; ?>
                                                            <? !empty($arItem['MIN_PRICE']['DISCOUNT_PCT']) and print '<span class="product__old-pct">'.$arItem['MIN_PRICE']['DISCOUNT_PCT'].'</span>'; ?>
                                                        </div>
                                                    <? else: ?>
                                                        <span class="product__cost-segment--<?= $arItem['MIN_PRICE']['DISCOUNT_SEGMENT'] ?>"><?= $arItem['MIN_PRICE']['PRINT_VALUE']; ?></span>
                                                    <? endif; ?>
                                                </div>
                                            </div>
                                            <div class="column-5">
